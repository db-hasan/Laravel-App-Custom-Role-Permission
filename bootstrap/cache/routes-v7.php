...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    2 => 
    array (
      0 => '{^(?|/update\\-(?|r(?|ole(?|/([^/]++)(?|(*:41))|\\-right/([^/]++)(*:65))|ight/([^/]++)(?|(*:89)))|user/([^/]++)(?|(*:114)))|/delete\\-r(?|ole/([^/]++)(*:149)|ight/([^/]++)(*:170))|/get\\-right\\-for\\-role/([^/]++)(*:210))/?$}sDu',
    ),
    3 => 
    array (
      41 => 
